...
// Set for Persian Sharetronix by Nipoto (Sharetronix.ir)
// 
...
function pdate($format,$timestamp=""){
			 $pdateMonthName = pdateMonthName();
			 $pdateWeekName = pdateWeekName();
			 $MonthDays = MonthDays();
